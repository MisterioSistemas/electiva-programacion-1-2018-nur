...
<body data-color="red">
    ...
    <div class="wrapper">
        ...
        <?php
            $Video = $VideoBLL->selectById($ID_VIDEO);
        ?>
        
        <div class="main-panel" style="background-color: white;">
            <div class="container-fluid" style="padding-top: 50px;">
                <div class="card" style="height: 20%; width: 80%; display: block;">
                   <video width="100%" height="100%" controls>
                        <source src="<?php echo $Video->getVideo(); ?>" type="video/mp4">
                        Your browser does not support the <code>video</code> tag.
                    </video>
                    <div class="card-body">
                        <h4 class="card-title" style="font-size: 18px;"><?php echo $Video->getTitulo(); ?></h4>
                        <p class="card-text" style="margin-top: -20px;"><small class="text-muted">Publicado: <?php echo $Video->getFecha(); ?></small></p>
                        <p class="card-text"><?php echo $Video->getDescripcion(); ?></p>
                        <div  class="blockquote">
                            <?php 
                                $Categorias = $CategoriaBLL->selectCatVideo($ID_VIDEO);
                                foreach ($Categorias as $cate) {
                            ?>
                            <span style="background-color: red; padding: 5px 5px;color: white;"><?php echo $cate->getNombre();?></span>
