    ...
    <div class="wrapper">
        <div class="sidebar" data-color="red" data-image="../assets/img/sidebar-1.jpg">
            <div class="sidebar-wrapper">
                <ul class="nav">
                    <li class="<?php if($Tipo == 'Juegos'){ echo 'active';}?>">
                        <a href="index.php?cat=Juegos&id=1">
                            <i class="material-icons">videogame_asset</i>
                            <p>Juegos</p>
                        </a>
                    </li>
                    <li class="<?php if($Tipo == 'Música'){ echo 'active';}?>">
                    ...
                    <li class="<?php if($Tipo == 'Trailers'){ echo 'active';}?>">
        ...
        <div class="main-panel" >
            <div class="container-fluid" style="width: 400px;">
                <form class="form-control" id="Formulario" action="Proceso.php" method="POST" enctype="multipart/form-data">
                    <h3 style="padding-left: 15px;font-weight: bold;" >Subir Video</h3>
                    <div class="form-group  is-empty">
                    ...
                    <div class="form-group  is-empty">
                        <input type="date" class="form-control" placeholder="Fecha" name="txtFecha"/>
                        <span class="material-input"></span>
                    </div>
                    <div >
                        ...
                        <input type="file" name="txtPortada"/>
                    </div>
                    <div class="form-group  is-empty">
                        <input type="text" class="form-control" placeholder="Autor" name="txtAutor"/>
                        <span class="material-input"></span>
                    </div>
                    <h4>Categoria:</h4>
                        <div class="blockquote">
                            <?php
                            $Categorias = $CategoriaBLL->selectAll();
                            foreach ($Categorias as $objCategoria) {
                                ?>
                            <span class="Casilla">
                                    <input type="checkbox" id="Categoria<?php echo $objCategoria->getId_categoria(); ?>"  name="Categoria<?php echo $objCategoria->getId_categoria(); ?>" value="<?php echo $objCategoria->getId_categoria(); ?>" />
                                    <label for="Categoria<?php echo $objCategoria->getId_categoria(); ?>"><?php echo $objCategoria->getNombre(); ?></label>
                            </span>     
                                <?php
                            }
                            ?>
                        </div>
                        <button type="submit" class="btn" style="margin-bottom: 0px;background-color: red; margin-left: 25px">
                            Enviar
                        </button>
                </form>
